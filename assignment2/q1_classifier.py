...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        # shape=(batch_size, n_features)  ==  [batch_size, n_features]
        self.labels_placeholder = tf.placeholder(tf.int32, shape=(64,100))
        ### END YOUR CODE
    ...
    def add_loss_op(self, pred):
        ...
        ### YOUR CODE HERE
        #pred=yhat
        loss = cross_entropy_loss(input_placeholder, pred)
        ### END YOUR CODE
        return loss
